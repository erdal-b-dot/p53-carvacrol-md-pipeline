...
**Virtual screening results.** All five analogs were docked to the 1TSR receptor using AutoDock Vina (exhaustiveness = 16; same box as the parent docking study). All five scored better than the parent fragment (Table 5; Figure 9b):
